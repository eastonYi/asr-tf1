...
class CONV(Encoder):
    ...
    def encode(self, features, len_feas):
        ...
        num_fc = self.args.model.encoder.num_fc
        ...
        x = tf.layers.dense(features, num_filters, use_bias=False)
        ...
        for i in range(num_fc):
            outputs = tf.layers.dense(outputs, units=hidden_size, use_bias=True)
